...
function getProducts(request, response) {
  ...
  let data = []
  const sqlOpdracht = db.prepare('SELECT products.id AS id, products.name AS name, products.code AS code, products.price AS price, products.color AS color, products.brand FROM products ORDER BY products.name')
...
function getProductById(request, response) {
  ...
  const sqlOpdracht = db.prepare('SELECT products.id AS id, products.name AS name, products.description AS description, products.code AS code, products.price AS price, brand_id AS brand, vooorraad_id AS voorraad, categorie_id AS categorie FROM products WHERE id = ?')
