...
function getProducts(request, response) {
  ...
  let data = []
  const sqlOpdracht = db.prepare('SELECT products.id AS id, products.name AS name, products.description AS description, products.code AS code, products.price AS price, brand_id AS brand, voorraad_id AS voorraad, categorie_id AS categorie FROM products ORDER BY products.name ASC')
...
function getProductById(request, response) {
  ...
  const sqlOpdracht = db.prepare('SELECT products.id AS id,   	products.name AS name, products.description AS 				  			description, 	products.code AS code, products.price AS 				price, brand_id AS 	brand, voorraad_id AS voorraad, 			  	categorie_id AS categorie 		FROM products WHERE id = ?')
